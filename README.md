...
Once the `conda-forge` channel has been enabled, `solarmach` can be installed with:

```
conda install solarmach
```

It is possible to list all of the versions of `solarmach` available on your platform with:
